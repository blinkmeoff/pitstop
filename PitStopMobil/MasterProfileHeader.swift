...
class MasterProfileHeader: UICollectionViewCell {
  ...
  private func setupRating(rating: Float) {
    let attributedText = NSMutableAttributedString(string: "\(rating)\n", attributes: [NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 14), NSAttributedStringKey.foregroundColor: UIColor.rgb(red: 22, green: 129, blue: 250)])
  ...
  override init(frame: CGRect) {
    ...
    usernameLabel.anchor(top: profileImageView.bottomAnchor, left: leftAnchor, bottom: feedbackLabel.topAnchor, right: rightAnchor, paddingTop: 4, paddingLeft: 12, paddingBottom: 0, paddingRight: 12, width: 0, height: 0)
